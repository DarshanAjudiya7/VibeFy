    ...
    <>
      <div className="flex flex-col h-full bg-black p-2 gap-2 text-white w-full max-w-[300px]">
        ...
        <div className="flex-1 bg-[#121212] rounded-lg p-2 flex flex-col min-h-0">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar px-2 py-2 space-y-1 pb-24">
            ...
            {userPlaylists.length === 0 && (
              <div className="px-4 py-8 text-center bg-white/5 rounded-xl border border-dashed border-white/10 mt-6">
