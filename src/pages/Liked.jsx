...
const Liked = () => {
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-4 sm:px-8 pt-16 sm:pt-6 pb-8 bg-gradient-to-b from-[#5038a0] to-[#121212] flex flex-col sm:flex-row items-center sm:items-end gap-6 min-h-[300px] text-center sm:text-left">
        <div className="w-40 h-40 sm:w-48 sm:h-48 md:w-60 md:h-60 bg-gradient-to-br from-[#450af5] to-[#c4efd9] shadow-[0_8px_24px_rgba(0,0,0,0.5)] flex items-center justify-center flex-shrink-0 rounded-lg sm:rounded-none">
          <FaHeart className="text-white text-6xl sm:text-7xl md:text-9xl" />
        </div>
        <div className="flex flex-col gap-2 w-full">
          <span className="text-xs font-bold uppercase tracking-wider">Playlist</span>
          <h1 className="text-4xl sm:text-5xl md:text-8xl font-black">Liked Songs</h1>
      ...
      {/* Control Bar */}
      <div className="px-4 sm:px-8 py-6 flex items-center justify-center sm:justify-start gap-8">
        <button
          onClick={handlePlayLiked}
          className="w-12 h-12 sm:w-14 sm:h-14 bg-[#1db954] rounded-full flex items-center justify-center text-black hover:scale-105 active:scale-95 transition-all shadow-xl"
        >
